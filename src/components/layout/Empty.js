    ...
    return (
        <div className="relative transform container mtt-4 mx-auto bg-white space-y-8 pb-24 pt-12 transition duration-200 dark:bg-gray-700 dark:text-white">
            ...
            <div className=" w-full h-3/5 flex flex-col justify-center items-center">
                ...
                <a href="/" className="w-4/6 px-4 py-2.5 bg-primaryGreen-200 bg-opacity-90 rounded shadow-sm dark:bg-opacity-60">
                    <h1 className="text-xs md:text-sm text-green-900 text-opacity-70 font-semibold w-full text-center dark:text-gray-700">متابعة التسوق</h1>
                </a>
            </div>
        </div>
    )
